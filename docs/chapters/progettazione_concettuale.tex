...
\begin{center}
    \includegraphics[width=3.5cm]{er_diagrams/er_1.png}
\end{center}
...
\begin{longtable}{|p{16.75cm}|}
    ...
    \\ \hline
    La fascia oraria d'apertura per un cinema in una giornata si ottiene
    considerando l'intervallo temporale formato
    dall'orario di inizio della prima proiezione della giornata nel cinema e
    dall'orario d'inizio dell'ultima proiezione della giornata nel cinema
    sommato alla durata del relativo film proiettato
    \\ \hline
\end{longtable}
