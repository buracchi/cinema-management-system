...
\begin{center}
    \includegraphics[width=5cm]{progconc/er_1.png}
\end{center}
...
\begin{center}
    \includegraphics[width=6cm]{progconc/er_2.png}
\end{center}
...
\begin{center}
    \includegraphics[width=11cm]{progconc/er_3.png}
\end{center}
...
\begin{center}
    \includegraphics[width=12cm]{progconc/er_4.png}
\end{center}

\pagebreak

Il concetto successivo è quello di prenotazione, le varie tipologie di
prenotazione verranno espresse tramite il costrutto della generalizzazione.

Poiché la validazione e l'annullamento delle proiezioni avvengono tramite
un codice di prenotazione non sarà necessario richiedere al cliente di
registrarsi ed effettuare il login per interagire con il sistema.
...
\begin{center}
    \includegraphics[width=12cm]{progconc/er_5.png}
\end{center}
...
\includegraphics[width=\linewidth]{progconc/er_6.png}
...
considerazioni sulle entità cinema e dipendente.
...
%
\includegraphics[width=\linewidth]{progconc/final-integration.png}
