...
\begin{tabularx}{\linewidth}{|X|X|}
    ...
    \textbf{Proiezioni}}                  \\\hline
    \rowcolor{tblhdrcolor}
    \multicolumn{1}{|l|}{\textbf{order\_idx}}
...
\inputsqlfile{../server/cinemadb/triggers/Cinema_BEFORE_INSERT_Check_Orario.sql}
\inputsqlfile{../server/cinemadb/triggers/Cinema_BEFORE_UPDATE_Check_Orario.sql}
...
\inputsqlfile{../server/cinemadb/triggers/Turni_BEFORE_INSERT_Check_Durata.sql}
...
\pagebreak
\inputsqlfile{../server/cinemadb/triggers/Turni_BEFORE_UPDATE_Check_Durata.sql}
