...
\begin{tabularx}{\linewidth}{|l|X|X|}
    ...
    \\ \hline
    Op. 5
     & Mostra tutti i posti disponibili in una proiezione.
     & 5000/giorno
    \\ \hline
    Op. 6
...
In questo modo
l'Operazione 7 consiste in un'unica scrittura riguardante
l'entità Prenotazione ed il suo costo viene ridotto da 2 000 a 1 000 accessi
al giorno,
l'Operazione 8 consiste in un'unica scrittura riguardante
l'entità Prenotazione ed il suo costo viene ridotto da 18 000 a 9 000 accessi
al giorno,
per finire l'attributo Stato comporta uno spreco di memoria pari a
% 140 000 * 1 byte
137 kB circa che risulta pienamente accettabile.
...
In questo modo il costo dell'operazione 4 rimane di 15 000 accessi al giorno
anziché incrementare a 25 000 accessi al giorno.
...
20 000 a 10 000 accessi al giorno.
...
%10 000 + 1 000 - 10000
1 000 accessi accessi aggiuntivi al giorno rispetto alla soluzione originale.
Pertanto non conviene introdurre la relazione PostoDisponibile
...
diversi attributi, poiché le operazioni richieste sono particolarmente semplici
non sarà necessario sostituirli con un codice identificativo.
...
Prenotazioni(cinema, sala, proiezione\_data, proiezione\_ora)
$\subseteq$
Proiezioni(cinema, sala, data, ora)

Prenotazioni(cinema, sala, posto\_fila, posto\_numero)
$\subseteq$
...
Notiamo che nessuna tabella presenta dipendenze funzioni non banali. 
