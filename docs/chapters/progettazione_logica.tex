...
\begin{tabularx}{\linewidth}{|l|X|X|}
    ...
    \\ \hline
    Op. 1
     & Mostra le proiezioni in programma.
     &
    \\ \hline
    Op. 2
...
In questo modo
l'Operazione 9 consisterà in un'unica scrittura riguardante
l'entità Prenotazione ed il suo costo si ridurrà da 2000 a 1000 accessi
al giorno,
l'Operazione 10 consisterà in un'unica scrittura riguardante
...
L'attributo multivalore Cast viene coinvolto unicamente durante l'Operazione 6,
...
In questo modo il costo dell'operazione 6 anziché incrementare a 25000
rimarrà di 15000 accessi al giorno.

Per ridurre il costo dell'operazione più costosa, ovvero l'Operazione 7 è
possibile introdurre una relazione PostoDisponibile tra le entità Proiezione e
Posto con cardinalità (0,N)|(0,N) riducendo il costo dell'Operazione 7 da
