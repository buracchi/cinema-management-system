...
\begin{longtable}{|p{\linewidth}|}
      ...
      Ogni cinema ha un numero arbitrario di sale.                      \\\hline
      Ogni cinema ha una fascia oraria di apertura.                     \\\hline
      Ogni sala è identificata da un numero di sala.                    \\\hline
      Ogni sala ha un numero arbitrario di posti.                       \\\hline
      Ogni posto è identificato da una lettera per la fila ed un numero
      di posto.                                                         \\\hline
      In ogni sala si possono proiettare più film nello stesso giorno.  \\\hline
      Ogni film può essere proiettato più volte nello stesso giorno ed
      in sale differenti.                                               \\\hline
      Ogni film ha una durata, un nome, un cast e una casa
      cinematografica.                                                  \\\hline
      Il prezzo di una prenotazione dipende dal film proiettato, dalla sala e
      dall'orario in cui avviene la proiezione.                         \\\hline
      Gli amministratori gestiscono la programmazione delle proiezioni. \\\hline
      I clienti possono prenotare un posto per una proiezione completando
      la procedura di prenotazione.                                     \\\hline
      I clienti hanno a disposizione 10 minuti per completare la procedura di
      prenotazione.                                                     \\\hline
      ...
      \begin{enumerate}
            ...
            \item il sistema restituisce al cliente un codice di
                  prenotazione
      \end{enumerate}              \\\hline
      I clienti possono annullare la propria prenotazione completando
      la procedura di annullamento di una prenotazione.                 \\\hline
      I clienti possono annullare la propria prenotazione entro 30 minuti
      dall'inizio della proiezione.                                     \\\hline
      La procedura di annullamento di una prenotazione è formata dai seguenti
      passaggi:
      \begin{enumerate}
            ...
            \item il sistema registra la prenotazione come prenotazione
                  annullata
      \end{enumerate}        \\\hline
      I dipendenti sono divisi in maschere e proiezionisti.             \\\hline
      Ogni dipendente può effettuare un turno in un qualunque cinema.   \\\hline
      Gli amministratori gestiscono la programmazione dei turni.        \\\hline
      La durata di una giornata lavorativa di un dipendente deve essere
      di massimo otto ore.                                              \\\hline
      I turni sono gestiti su base settimanale.                         \\\hline
