...
\begin{longtable}{|p{3.86cm}|p{3.86cm}|p{3.86cm}|p{3.86cm}|}
    ...
    \\ \hline
    Biglietto
     & Titolo di accesso ad un cinema associato ad una prenotazione,
    contiene i dati della prenotazione ed è valido per la relativa proiezione.
     &
    ...
    \\ \hline
    Biglietto utilizzato
     & Un biglietto associato ad una prenotazione confermata utilizzata.
     &
    ...
    Prenotazione annullata
     ...
     & Prenotazione
    \\ \hline
    Prenotazione confermata utilizzata
