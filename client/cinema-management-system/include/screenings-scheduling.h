...
extern errno_t get_screenings(cinema_management_system_t system, struct get_screenings_response* response);
...
extern errno_t add_screening(cinema_management_system_t system, struct add_screening_request request);
...
extern errno_t get_available_projectionists(cinema_management_system_t system, struct get_available_projectionists_request request, struct get_available_projectionists_response* response);

struct add_screening_request { int32_t employee_id; int32_t cinema_id; uint8_t hall_number; char day[11]; char start_time[9]; };
extern errno_t assign_projectionist(cinema_management_system_t system, struct add_screening_request request);

struct delete_screening_request { int32_t employee_id; char day[11]; char start_time[9]; };
extern errno_t delete_screening(cinema_management_system_t system, struct delete_screening_request request);
