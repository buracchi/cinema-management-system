...
struct cms_add_screening_response {
	struct cms_response;
};
...
struct cms_delete_screening_request {
	int32_t cinema_id;
	int32_t hall_number;
	char date[CMS_DATE_LEN];
	char start_time[CMS_TIME_LEN];
};
struct cms_delete_screening_response {
	struct cms_response;
};
...
struct cms_get_available_projectionists_request {
	int32_t cinema_id;
	int32_t hall_number;
	char date[CMS_DATE_LEN];
	char start_time[CMS_TIME_LEN];
...
struct cms_assign_projectionist_request {
	int32_t projectionist_id;
	int32_t cinema_id;
	int32_t hall_number;
	char date[CMS_DATE_LEN];
